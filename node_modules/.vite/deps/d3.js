...
function autoType(object) {
  for (var key in object) {
    var value = object[key].trim(), number, m3;
    if (!value)
      value = null;
    else if (value === "true")
      value = true;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon5))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da2, da1 = da2, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon5 && (padRadius ? +padRadius.apply(this, arguments) : sqrt2(r0 * r0 + r1 * r1)), rc = min3(abs3(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t0, t1;
      if (rp > epsilon5) {
        var p0 = asin(rp / r0 * sin2(ap)), p1 = asin(rp / r1 * sin2(ap));
        if ((da0 -= p0 * 2) > epsilon5)
...
function pie_default() {
  var value = identity_default2, sortValues = descending_default, sort2 = null, startAngle = constant_default7(0), endAngle = constant_default7(tau4), padAngle = constant_default7(0);
  function pie(data) {
